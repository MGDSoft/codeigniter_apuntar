			...
			<?= (($usuario_configuracion->contacto_pagina_personal != "")? '<a href="'.$usuario_configuracion->contacto_pagina_personal.'" target="_blank"><img width="32" height="32" class="pag_perso" src="'.PATH_IMG.'1x1.gif" alt="'.$this->lang->line('contacto_pagina_personal').'" title="'.$this->lang->line('contacto_pagina_personal').'"></a>' : '' )?>
 			...
 			<?= (($usuario_configuracion->contacto_steam != "")? '<a href="'.$usuario_configuracion->contacto_email.'" target="_blank"><img width="32" height="32"  class="email" src="'.PATH_IMG.'1x1.gif"></a>' : '' )?>
 			...
 			<?= ((isset($usuario_configuracion->nombre_unico)) ? '<a href="/'.$usuario_configuracion->nombre_unico .'/rss" target="_blank"><img  width="32" height="32" class="rss" src="'. PATH_IMG .'1x1.gif"></a> 			</span> ' :'') ?>