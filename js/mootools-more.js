...
// Load this file's selection again by visiting: http://mootools.net/more/09e9ab537d918d0ece964ba14ab676fd 
// Or build this file again with packager using: packager build More/Chain.Wait More/Array.Extras More/Hash More/Hash.Extras More/Element.Forms More/Elements.From More/Element.Measure More/Element.Position More/Form.Request More/Form.Request.Append More/Fx.Elements More/Fx.Move More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Slider More/Sortables More/Hash.Cookie More/Scroller More/Color
/*
---
copyrights:
...
...
*/
MooTools.More={version:"1.4.0.1",build:"a4244edf2aa97ac8a196fc96082dd35af1abab87"};(function(){var a=this.Color=new Type("Color",function(c,d){if(arguments.length>=3){d="rgb";c=Array.slice(arguments,0,3);}else{if(typeof c=="string"){if(c.match(/rgb/)){c=c.rgbToHex().hexToRgb(true);}else{if(c.match(/hsb/)){c=c.hsbToRgb();}else{c=c.hexToRgb(true);
...
return g;}:e);});return b;};var IframeShim=new Class({Implements:[Options,Events,Class.Occlude],options:{className:"iframeShim",src:'javascript:false;document.write("");',display:false,zIndex:null,margin:0,offset:{x:0,y:0},browsers:(Browser.ie6||(Browser.firefox&&Browser.version<3&&Browser.Platform.mac))},property:"IframeShim",initialize:function(b,a){this.element=document.id(b);
...
}return(a||a===0)&&a>=0&&a<this.lists.length?b[a]:b;}});Hash.Cookie=new Class({Extends:Cookie,options:{autoSave:true},initialize:function(b,a){this.parent(b,a);
...
this.$chk = function(obj){	return !!(obj || obj === 0);	};	this.$defined = function(obj){	return (obj != null);	};this.$empty=function() {}; this.$type  =function(obj) {typeOf(obj)};